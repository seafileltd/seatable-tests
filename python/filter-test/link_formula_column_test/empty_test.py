...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, LINK_FORMULA_EMPTY_FILTER, \
...
COLUMN_TYPE = 'link-formula-empty'
...
def run(base, table_name, print_out=True):
    ...
    for f in LINK_FORMULA_EMPTY_FILTER:
...
def run_link_formula_column_test(base, local_test):
    table_name = 'LinkLookUp'
...
if __name__ == '__main__':
    ...
    run_link_formula_column_test(base, LOCAL_TEST)
