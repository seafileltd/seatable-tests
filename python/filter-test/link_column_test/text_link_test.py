...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, TEXT_LINK_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in TEXT_LINK_FILTER_CONSTANTS:
...
def run_text_link_column_test(base, local_test):
    table_name = 'LinkText'
...
if __name__ == '__main__':
    ...
    run_text_link_column_test(base, LOCAL_TEST)
