...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, SINGLE_SELECT_LINK_FILTER_CONSTANTS, \
...
COLUMN_TYPE = 'link-single-select'
...
def run(base, table_name, print_out=True):
    ...
    for f in SINGLE_SELECT_LINK_FILTER_CONSTANTS:
...
def run_single_select_link_column_test(base, local_test):
    table_name = 'LinkSingleSelect'
...
if __name__ == '__main__':
    ...
    run_single_select_link_column_test(base, LOCAL_TEST)
