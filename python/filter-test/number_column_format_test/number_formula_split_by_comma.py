...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, NUMBER_FORMULA_SPLIT_BY_COMMA_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in NUMBER_FORMULA_SPLIT_BY_COMMA_FILTER_CONSTANTS:
...
def run_number_formula_split_by_comma_column_test(base, local_test):
    table_name = 'NumberFomulaSplitByComma'
...
if __name__ == '__main__':
    ...
    run_number_formula_split_by_comma_column_test(base, LOCAL_TEST)
