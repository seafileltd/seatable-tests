...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, NUMBER_FORMULA_CURRENCY_US_FILTER_CONSTANTS, \
...
COLUMN_TYPE = 'formula-number-currency-US'
...
def run(base, table_name, print_out=True):
    ...
    for f in NUMBER_FORMULA_CURRENCY_US_FILTER_CONSTANTS:
...
def run_number_formula_currency_us_column_test(base, local_test):
    table_name = 'NumberFormulaCurrencyUS'
...
if __name__ == '__main__':
    ...
    run_number_formula_currency_us_column_test(base, LOCAL_TEST)
