...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, NUMBER_FORMULA_DOT_SPLIT_BY_DOT_FILTER_CONSTANTS, \
...
COLUMN_TYPE = 'formula-number-split-by-comma'
...
def run(base, table_name, print_out=True):
    ...
    for f in NUMBER_FORMULA_DOT_SPLIT_BY_DOT_FILTER_CONSTANTS:
...
def run_number_formula_dot_split_by_dot_column_test(base, local_test):
    table_name = 'NumberFomulaDotSplitByDot'
    test_result_table_name = 'TestResultNumber'
...
if __name__ == '__main__':
    ...
    run_number_formula_dot_split_by_dot_column_test(base, LOCAL_TEST)
