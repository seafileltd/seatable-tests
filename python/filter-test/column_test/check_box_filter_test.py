...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, CHECKBOX_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in CHECKBOX_FILTER_CONSTANTS:
        ...
        print("db-length-%s: page-length-%s" % (
            len(filter_rows_db), len(filter_rows_page)
        ))
...
def run_checkbox_column_test(base, local_test):
    table_name = 'CheckboxFilter'
...
if __name__ == '__main__':
    ...
    run_checkbox_column_test(base, LOCAL_TEST)
