...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, SINGLE_SELECT_FILETER_CONSTANT, \
...
def run(base, table_name, print_out=True):
    ...
    for f in SINGLE_SELECT_FILETER_CONSTANT:
...
def run_single_column_test(base, local_test):
    table_name = 'SingleSelectFilter'
...
if __name__ == '__main__':
    ...
    run_single_column_test(base, LOCAL_TEST)
