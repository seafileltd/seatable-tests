...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, NUMBER_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in NUMBER_FILTER_CONSTANTS:
...
def run_number_colum_test(base, local_test):
    table_name = 'NumberFilter'
...
if __name__ == '__main__':
    ...
    run_number_colum_test(base, LOCAL_TEST)
