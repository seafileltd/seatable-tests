...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, MODIFIER_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in MODIFIER_FILTER_CONSTANTS:
...
def run_modifier_colum_test(base, local_test):
    table_name = 'CreatorAndModifilerFilter'
...
if __name__ == '__main__':
    ...
    run_modifier_colum_test(base, LOCAL_TEST)
