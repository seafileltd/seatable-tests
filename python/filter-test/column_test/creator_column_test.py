...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, CREATOR_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in CREATOR_FILTER_CONSTANTS:
...
def run_creator_colum_test(base, local_test):
...
if __name__ == '__main__':
    ...
    run_creator_colum_test(base, LOCAL_TEST)
