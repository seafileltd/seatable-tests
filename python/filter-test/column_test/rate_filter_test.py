...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, RATE_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in RATE_FILTER_CONSTANTS:
...
def run_rate_colum_test(base, local_test):
    table_name = 'RateFilter'
...
if __name__ == '__main__':
    ...
    run_rate_colum_test(base, LOCAL_TEST)
