...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, FILE_FILETER_CONSTANT, \
...
def run(base, table_name, print_out=True):
    ...
    for f in FILE_FILETER_CONSTANT:
...
def run_file_column_test(base, local_test):
    table_name = 'FileFilter'
...
if __name__ == '__main__':
    ...
    run_file_column_test(base, LOCAL_TEST)
