...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, URL_FILTER_CONSTANTS, \
...
def run_url_column_test(base, local_test):
    table_name = 'URLFilter'
...
if __name__ == '__main__':
    ...
    run_url_column_test(base, LOCAL_TEST)
