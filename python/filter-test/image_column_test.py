...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, IMAGE_FILETER_CONSTANT, \
...
def run(base, table_name, print_out=True):
    ...
    for f in IMAGE_FILETER_CONSTANT:
...
def run_image_column_test(base, local_test):
    table_name = 'ImageFilter'
...
if __name__ == '__main__':
    ...
    run_image_column_test(base, LOCAL_TEST)
