...
from filter_constant import API_TOKEN, DTABLE_WEB_SERVER_URL, BOOL_FORMULA_FILTER_CONSTANTS, \
...
def run(base, table_name, print_out=True):
    ...
    for f in BOOL_FORMULA_FILTER_CONSTANTS:
...
def run_bool_formula_column_test(base, local_test):
    table_name = 'BoolFormula'
...
if __name__ == '__main__':
    ...
    run_bool_formula_column_test(base, LOCAL_TEST)
