...
def generate_filter_constant():
    ...
    for item in filter_constant:
        item['filter'].update({'column_key': '68nL'})
...
def run_date_formula_column_test(base, local_test):
    table_name = 'DateFomula'
...
if __name__ == '__main__':
    ...
    base.auth()
    #
    run_date_formula_column_test(base, LOCAL_TEST)
